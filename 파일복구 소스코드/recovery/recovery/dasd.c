...
#include "ntfs.h"
#include "mft.h"
#define save_path L"C:\\Users\\은별\\Desktop\\정재훈\\Recovery_File_Explorer\\Code\\test.txt"
...
void saveToFile(wchar_t* file_name, U64 mft_count);

U64 Real_segMFTOffset[20]={'\0'};
...
void saveToFile(wchar_t* file_name, U64 mft_count)
{
    FILE* file = _wfopen(save_path, L"a");  // "a" 모드: 파일 끝에 추가, 파일이 없으면 생성
